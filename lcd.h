...
***********************************************************/	
void int_to_string3(unsigned int val,unsigned char *temp_str_data)
{	
   // char str_data[4]=0;
	  temp_str_data[0]=48+((val%1000)/100);
...
void int_to_string1(unsigned int val,unsigned char *temp_str_data)
{	
   // char str_data[4]=0;
	  temp_str_data[0]=48+(val);
	
   // return str_data;
}

void int_to_string2(unsigned int val,unsigned char *temp_str_data)
{	
   // char str_data[4]=0;
	  temp_str_data[0]=(val);
